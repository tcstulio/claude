...
const DEFAULT_MAX_PENDING = parseInt(process.env.QUEUE_MAX_PENDING || '50', 10);
const MAX_HISTORY = 100; // máximo de delivered/failed em memória
...
class MessageQueue extends EventEmitter {
  ...
  enqueue(message, destination, channel) {
    ...
    // Descarta as mais velhas se atingiu o limite
